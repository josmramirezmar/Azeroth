// Definicion del mapa de islas quebradas
var Mislas = {
  preload: function() {
    // Carga de las imágenes
		juego.load.image("imgfond", "../imagenes/mapislas.jpg");
  ...
  // Inicializacion
    ...
    binf = juego.add.button(1120, 710, "bubi", this.info, this); // crea el botón y le asigna una función
  ...
  info: function() {
    var url = "../html/continentes.html#isla";
