// Definicion del mapa de rasganorte
var Mrasganorte = {
  preload: function() {
    // Carga de las imágenes
		juego.load.image("imgfond", "../imagenes/maprasganorte.jpg");
  ...
  // Inicializacion
    ...
    binf = juego.add.button(550, 800, "bubi", this.info, this); // crea el botón y le asigna una función
  ...
  info: function() {
    var url = "../html/continentes.html#rasg";
