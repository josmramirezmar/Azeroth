// Definicion del mapa de kalimdor
var Mkalimdor = {
  preload: function() {
    // Carga de las imágenes
		juego.load.image("imgfond", "../imagenes/mapkalimdor.jpg");
  ...
  // Inicializacion
    ...
    binf = juego.add.button(700, 400, "bubi", this.info, this); // crea el botón y le asigna una función
  ...
  info: function() {
    var url = "../html/continentes.html#kali";
