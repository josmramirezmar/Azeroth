// Definicion del mapa de pandaria
var Mpandaria = {
  preload: function() {
    // Carga de las imágenes
		juego.load.image("imgfond", "../imagenes/mappandaria.jpg");
  ...
  // Inicializacion
    ...
    binf = juego.add.button(300, 820, "bubi", this.info, this); // crea el botón y le asigna una función
  ...
  info: function() {
    var url = "../html/continentes.html#pand";
